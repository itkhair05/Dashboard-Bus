...
$partners = [];
try {
    $stmt = $db->query("SELECT partner_id, name, email, phone, status, created_at, policy FROM partners ORDER BY created_at DESC LIMIT 500");
...
<body>
  ...
  <div class="sidebar">
    ...
    <nav class="nav flex-column mt-3">
      ...
      <a class="nav-link active" href="admin_partners.php"><i class="fas fa-bus"></i><span>Quản lý nhà xe</span></a>
              ...
              <td class="text-center">
                <div class="d-flex justify-content-center gap-1">
                  ...
                  <button class="action-btn btn-edit" data-bs-toggle="modal" data-bs-target="#editPartnerModal"
                          ...
                          data-policy="<?= htmlspecialchars($p['policy'] ?? '') ?>" title="Chỉnh sửa">
