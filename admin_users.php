...
<body>
  ...
  <div class="sidebar">
    ...
    <nav class="nav flex-column mt-3">
      ...
      <a class="nav-link active" href="admin_users.php"><i class="fas fa-users"></i><span>Quản lý người dùng</span></a>
        ...
        <table class="table table-hover mb-0" id="usersTable">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <span class="badge bg-<?= $u['role']==='admin'?'dark':'secondary' ?> px-3 py-2">
