...
<head>
  ...
  <style>
    :root { --primary: #20c997; --primary-hover: #1baa80; --secondary: #17a2b8; --success: #10b981; --danger: #ef4444; --warning: #f59e0b; --info: #0dcaf0; --dark: #1f2937; --light: #f8fafc; --gray: #94a3b8; --border: #e2e8f0; }
...
<body>
  ...
  <div class="sidebar">
    ...
    <nav class="nav flex-column mt-3">
      ...
      <a class="nav-link active" href="admin_reports.php"><i class="fas fa-chart-line"></i><span>Báo cáo</span></a>
